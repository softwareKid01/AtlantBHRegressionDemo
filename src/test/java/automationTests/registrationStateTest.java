...
public class registrationStateTest extends baseTest {
    @Test
    public void registerCiryError() throws InterruptedException {
        ...
        registrationPage.enterAccountInfo("Mehmedalija", "Dizdar", "password12345@#", "Energoinvest", "ZaimaSarca23A", "Toronto", "", "00000");
